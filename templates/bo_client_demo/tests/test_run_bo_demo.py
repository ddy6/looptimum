...
def test_multi_objective_weighted_sum_updates_best_and_surrogate_scoring(
    template_copy: Path,
) -> None:
    ...
    first_path = template_copy / "examples" / "_multi_objective_demo_seed_1.json"
    ...
    second_path = template_copy / "examples" / "_multi_objective_demo_seed_2.json"
